...
def main():
    ...
    website_menu = st.sidebar.selectbox("Menu", ("Emotion Recognition", "Emotion Recognition"), disabled=True)
    st.set_option('deprecation.showfileUploaderEncoding', False)

    if website_menu == "Emotion Recognition":
        st.sidebar.subheader("Model")
        model_type = st.sidebar.selectbox("How would you like to predict?", ("mfccs", ""), disabled=True)
